...
export const CardTravel = ({className, tiket}) => {
  return (
    <div
      className={`shadow-lg p-4 rounded-lg cursor-pointer bg-white my-2 ${className}`}
    >
      ...
      <div className="flex">
        <div className="flex-1">
          ...
          <p className="text-sm font-bold text-carbonGrey uppercase">
            {tiket?.stasiun_berangkat} ({tiket?.stasiun_berangkat_inisial})
          </p>
        </div>
        <div className="flex-1 text-right">
          ...
          <p className="text-sm font-bold text-carbonGrey uppercase">
            {tiket?.stasiun_tujuan} ({tiket?.stasiun_tujuan_inisial})
          </p>
        </div>
      </div>
      <div className="flex">
        <div className="flex-1">
          ...
          <p className="text-sm font-bold text-carbonGrey">
