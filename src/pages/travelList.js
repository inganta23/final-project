...
export const TravelList = (tikets) => {
  ...
  if(day.length === 0 && tikets.tglBerangkat){
    const arrDate = [];
    console.log(tikets.tglBerangkat);
        ...
        <div className="w-3/5">
          ...
          <div className="mt-4">
            { flag &&
              ...
              {!flag && <svg role="status" class="inline w-10 h-10 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
